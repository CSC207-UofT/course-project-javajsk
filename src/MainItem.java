...
/**
 * public class representing a Main Item to be sold as a sellable item.
 *
 ...
 */
public class MainItem implements Sellable {
    boolean isAvailable;
    String id;
    float price;
    String name;
     ...
     */
    public MainItem(String id, String name, float price, String description, boolean available, float discount){
        this.id = id;
        this.name = name;
        this.price = price;
